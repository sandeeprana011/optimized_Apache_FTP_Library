...
import optimized.apache.ftp.FTPClientConfig;
 ...
 *
 * @see optimized.apache.ftp.FTPFileEntryParser FTPFileEntryParser (for usage instructions)
...
//    @Override
    ...
    public FTPFile[] parseFileList(java.io.InputStream listStream) throws IOException {
        optimized.apache.ftp.FTPListParseEngine engine = new optimized.apache.ftp.FTPListParseEngine(this);
