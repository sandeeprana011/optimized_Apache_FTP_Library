...
import optimized.apache.MalformedServerReplyException;
import optimized.apache.ftp.parser.DefaultFTPFileEntryParserFactory;
import optimized.apache.ftp.parser.FTPFileEntryParserFactory;
import optimized.apache.ftp.parser.MLSxEntryParser;
import optimized.apache.io.CRLFLineReader;
import optimized.apache.io.CopyStreamAdapter;
import optimized.apache.io.CopyStreamEvent;
import optimized.apache.io.CopyStreamListener;
import optimized.apache.io.FromNetASCIIInputStream;
import optimized.apache.io.ToNetASCIIOutputStream;
import optimized.apache.io.Util;
 ...
 * from {@link optimized.apache.SocketClient},
 ...
 * an {@link optimized.apache.ftp.FTPConnectionClosedException}
 * .
 ...
 * {@link optimized.apache.ftp.FTPConnectionClosedException}
 ...
 * can also throw a
 * {@link optimized.apache.MalformedServerReplyException}
 * , which is a subclass
 ...
 * @see FTPClientConfig
 *
 * @see optimized.apache.MalformedServerReplyException
 */
...
implements Configurable
{
    ...
    throws IOException
    {
        ...
        return new optimized.apache.io.SocketOutputStream(socket, output);
    }
     ...
     *
     * @see optimized.apache.ftp.parser.FTPFileEntryParserFactory
     * @see optimized.apache.ftp.parser.DefaultFTPFileEntryParserFactory
     */
     ...
     *      to send FTP reply code 421.  This exception may be caught either
     *      as an IOException or independently as itself.
     * @throws optimized.apache.io.CopyStreamException If an I/O error occurs while actually
    ...
    throws IOException
    {
        ...
        return new optimized.apache.io.SocketInputStream(socket, input);
    }
     ...
     *                   from the server.
     * @throws optimized.apache.ftp.parser.ParserInitializationException Thrown if the parserKey parameter cannot be
     ...
     * @see optimized.apache.ftp.parser.DefaultFTPFileEntryParserFactory
     * @see optimized.apache.ftp.parser.FTPFileEntryParserFactory
     * @see optimized.apache.ftp.FTPFileEntryParser
     */
     ...
     *                   If an I/O error occurs while either sending a
     *                   command to the server or receiving a reply from the server.
     * @throws optimized.apache.ftp.parser.ParserInitializationException Thrown if the autodetect mechanism cannot
